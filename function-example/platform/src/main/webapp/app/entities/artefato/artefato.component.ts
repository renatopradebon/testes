...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/artefato'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Artefato) {
        return item.id;
    }
    registerChangeInArtefatoes() {
        this.eventSubscriber = this.eventManager.subscribe('artefatoListModification', (response) => this.loadAll());
    }
